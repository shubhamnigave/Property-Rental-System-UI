...
// const stripePromise = loadStripe("pk_test_51QoJxNRXKTyEpnQrC8EHWCBb6ESXEuOYVjLuGg2TUH4kIr2RS2fCoPfkERSU2EuGCVKSwYGd8qA9Sk4WLEOzZExL00id81Y6OE");
...
//     // console.log(JSON.parse(property))
//     console.log(bookingId,property.amount);
